...
$stmt = $conn->prepare("SELECT * FROM postres ");
$stmt->execute();
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Tabla Auxiliar: Postre</h1>
                    </div>
                    ...
                    <div class="contenedor-formulario-dash">
                        <form action="insert.php" autocomplete="off" method="POST" class="formulario-dash">
                            ...
                            <input type="text" name="nombre_postre" id="nombre_postre" placeholder="Nombre del postre">
                            <input type="submit" name="agregar-postre" class="btn btn-sm btn-success" value="Ingresar Postre">
                        </form>
                    </div>
                    <!-- End of Page Heading -->
                    ...
                    <div>
                        <h3 class="titulo-table-dash">Lista de Postres</h3>
                        <table class="table-dashboard">
                            ...
                            <tbody>
                                ...
                                <th><button type="button" class="btn btn-sm btn-danger shadow-sm" data-bs-toggle="modal" data-bs-target="#modalEliminar<?= $row['id_postre'] ?>">
                                    ...
                                    <div class="modal fade" id="modalEliminar<?= $row['id_postre'] ?>" tabindex="-1" aria-labelledby="modalLabel<?= $row['id_postre'] ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger text-white">
                                                    <h5 class="modal-title" id="modalLabel<?= $row['id_postre'] ?>">¿Estás seguro?</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                                </div>
                                                    <div class="modal-body">
                                                        Esta acción eliminará el postre <strong><?= $row['nombre_postre'] ?></strong>. Esta operación no se puede deshacer.
                                                    </div>
