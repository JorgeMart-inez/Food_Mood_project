...
$stmt = $conn->prepare("SELECT * FROM paquete");
$stmt->execute();
                ...
                <div class="container-fluid">
                    ...
                    <div id="formulario-flotante" class="contenedor-formulario oculto">
                        <form action="insert.php" autocomplete="off" method="POST" class="formulario-maintable-dash">
                            ...
                            <input type="submit" name="agregar-paquete" class="btn btn-sm btn-success" value="Ingresar Paquete">
                        </form>
                    </div>
                    <!-- End of Page Heading -->
                    ...
                    <div>
                        ...
                        <table class="table-dashboard">
                            ...
                            <tbody>
                                ...
                                <td><?= $row['anfitrion']?></td>
                                <td><?= $row['fk_evento']?></td>
                                <td><?= $row['fk_aperitivo']?></td>
                                <td><?= $row['fk_entrada']?></td>
                                <td><?= $row['fk_plato_fuerte']?></td>
                                <td><?= $row['fk_postre']?></td>
                                <td><?= $row['fk_bebida']?></td>
                                <td><?= $row['fk_metodo_pago']?></td>
                                
                                <th><form action=""><a name="modificar-paquete" class="btn btn-sm btn-primary shadow-sm" href="update_paquete.php?id_paquete=<?= $row['id_paquete']?>">Modificar</a></form></th>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger text-white">
                                                    ...
                                                    <div class="modal-body">
                                                        Esta acción eliminará el paquete <strong><?= $row['nombre_paquete'] ?></strong>. Esta operación no se puede deshacer.
                                                    </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                    <a href="delete_paquete.php?id_paquete=<?= $row['id_paquete'] ?>" class="btn btn-danger">Eliminar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
