...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $id_datos_pago = $_GET['id_datos_pago'];
    $stmt = $conn->prepare("SELECT * FROM datos_pago WHERE id_datos_pago = :id_datos_pago");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-maintable-dash">Modificar Datos de Pago</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_datos_pago.php" autocomplete="off" method="POST" class="formulario-dash">

                            <label for="id_datos_pago">ID datos de pago:</label>
                            <input type="number" name="id_datos_pago" id="id_datos_pago" value="<?= $row['id_datos_pago'] ?>" readonly>
                            
                            <label for="referencia_pago">Referencia de Pago:</label>
                            <input type="text" name="referencia_pago" id="referencia_pago" value="<?= $row['referencia_pago'] ?>" placeholder="Ingrese la Referencia" readonly>

                            <label for="fk_metodo_pago">Método de pago:</label>
                            <select name="fk_metodo_pago" id="fk_metodo_pago">
                                <option value="">Seleccionar Método de Pago</option>
                                <option value="1" <?= $row['fk_metodo_pago'] == 1 ? 'selected' : ''?>>Transferencia</option>
                                <option value="2" <?= $row['fk_metodo_pago'] == 2 ? 'selected' : ''?>>Efectivo</option>
                                <option value="3" <?= $row['fk_metodo_pago'] == 3 ? 'selected' : ''?>>Débito</option>
                                <option value="4" <?= $row['fk_metodo_pago'] == 4 ? 'selected' : ''?>>Crédito</option>
                            </select>
                            ...
                            <input type="date" name="fecha_pago" id="fecha_pago" value="<?= $row['fecha_pago']?>" placeholder="Ingrese la fecha de pago">

                            <label for="fk_cliente">ID de Cliente:</label>
                            <input type="number" name="fk_cliente" id="fk_cliente" value="<?= $row['fk_cliente']?>" placeholder="Ingrese el ID del cliente">

                            <label for="fk_usuario">ID de Usuario</label>
                            <input type="number" name="fk_usuario" id="fk_usuario" value="<?= $row['fk_usuario']?>" placeholder="Ingrese el ID del Usuario">
                            
                            <input type="submit" name="modificar-datos-pago" class="btn btn-sm btn-success" value="Modificar Datos de Pago">
