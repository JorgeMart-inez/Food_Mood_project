...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $stmt = $conn->prepare("SELECT * FROM entradas WHERE id_entrada = :id_entrada");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Modificar Entrada</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_entrada.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_entrada">ID Entrada:</label>
                            <input type="text" name="id_entrada" placeholder="ID" value="<?= $row['id_entrada']?>" readonly>

                            <label for="nombre_entrada">Nombre: </label>
                            <input type="text" name="nombre_entrada" placeholder="Nombre de la entrada" value="<?= $row['nombre_entrada']?>">
                            
                            <input type="submit" name="modificar-entrada" class="btn btn-sm btn-success" value="Modificar entrada">
