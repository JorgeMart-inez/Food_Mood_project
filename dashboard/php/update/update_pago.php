...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $stmt = $conn->prepare("SELECT * FROM pago WHERE id_pago = :id_pago");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-maintable-dash">Modificar Pago</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_pago.php" autocomplete="off" method="POST" class="formulario-dash">

                            <label for="id_pago">ID del Pago:</label>
                            <input type="number" name="id_pago" id="id_pago" value="<?= $row['id_pago'] ?>" readonly>
                            
                            <label for="fk_paquete">FK del Paquete:</label>
                            <input type="number" name="fk_paquete" id="fk_paquete" value="<?= $row['fk_paquete'] ?>" readonly>

                            <label for="fk_cotizacion">FK de la Cotización:</label>
                            <input type="number" name="fk_cotizacion" id="fk_cotizacion" value="<?= $row['fk_cotizacion']?>" readonly>
                            
                            <label for="fk_cliente">FK del Cliente:</label>
                            <input type="number" name="fk_cliente" id="fk_cliente" value="<?= $row['fk_cliente']?>" readonly>

                            <label for="fk_datos_pago">FK del Dato de Pago:</label>
                            <input type="number" name="fk_datos_pago" id="fk_datos_pago" value="<?= $row['fk_datos_pago']?>" readonly>
                            
                            <input type="submit" name="modificar-pago" class="btn btn-sm btn-success" value="Modificar Pago">
