...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $stmt = $conn->prepare("SELECT * FROM cotizacion WHERE id_cotizacion = :id_cotizacion");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-maintable-dash">Modificar Cotizacion</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_cotizacion.php" autocomplete="off" method="POST" class="formulario-dash">

                            <label for="id_cotizacion">ID del Pago:</label>
                            <input type="number" name="id_cotizacion" id="id_cotizacion" value="<?= $row['id_cotizacion'] ?>" readonly>
                            ...
                            <input type="number" name="fk_cliente" id="fk_cliente" value="<?= $row['fk_cliente'] ?>">

                            <label for="fk_evento">ID del Evento:</label>
                            <input type="number" name="fk_evento" id="fk_evento" value="<?= $row['fk_evento'] ?>">
                            
                            <label for="total">Total:</label>
                            <input type="number" name="total" id="total" value="<?= $row['total'] ?>" placeholder="Nuevo total de la cotización">
                            
                            <input type="submit" name="modificar-cotizacion" class="btn btn-sm btn-success" value="Modificar Cotización">
