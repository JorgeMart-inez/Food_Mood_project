            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-maintable-dash">Modificar Usuario</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_usuario.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_usuario">ID Usuario:</label>
                            <input type="text" name="id_usuario" placeholder="ID" value="<?= $row['id_usuario']?>" readonly>

                            <label for="correo_usuario">Correo: </label>
                            <input type="text" name="correo_usuario" placeholder="Nuevo  Correo del Usuario" value="<?= $row['correo']?>">
