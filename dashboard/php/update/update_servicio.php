...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $stmt = $conn->prepare("SELECT * FROM servicios WHERE id_servicio = :id_servicio");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Modificar Servicio</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_servicio.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_servicio">ID Servicio:</label>
                            <input type="text" name="id_servicio" placeholder="ID" value="<?= $row['id_servicio']?>" readonly>

                            <label for="nombre_servicio">Nombre: </label>
                            <input type="text" name="nombre_servicio" placeholder="Nombre del servicio" value="<?= $row['nombre_servicio']?>">

                            <label for="precio_servicio">Precio:</label>
                            <input type="number" name="precio_servicio" placeholder="Precio del servicio" value="<?= $row['precio_servicio']?>">
                            
                            <input type="submit" name="modificar-servicio" class="btn btn-sm btn-success" value="Modificar servicio">
