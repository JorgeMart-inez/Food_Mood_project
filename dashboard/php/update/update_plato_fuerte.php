...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $id_plato_fuerte = $_GET['id_plato_fuerte'];
    $stmt = $conn->prepare("SELECT * FROM plato_fuerte WHERE id_plato_fuerte = :id_plato_fuerte");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Modificar Plato Fuerte</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_plato_fuerte.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_plato_fuerte">ID Plato Fuerte:</label>
                            <input type="text" name="id_plato_fuerte" placeholder="ID" value="<?= $row['id_plato_fuerte']?>" readonly>

                            <label for="nombre_plato_fuerte">Nombre: </label>
                            <input type="text" name="nombre_plato_fuerte" placeholder="Nombre del plato fuerte" value="<?= $row['nombre_plato_fuerte']?>">
                            
                            <input type="submit" name="modificar-plato-fuerte" class="btn btn-sm btn-success" value="Modificar Plato Fuerte">
