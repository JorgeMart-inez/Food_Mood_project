...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $stmt = $conn->prepare("SELECT * FROM metodo_pago WHERE id_metodo_pago = :id_metodo_pago");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Modificar Método de Pago</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_metodo_pago.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_metodo_pago">ID Método de Pago:</label>
                            <input type="text" name="id_metodo_pago" placeholder="ID" value="<?= $row['id_metodo_pago']?>" readonly>
