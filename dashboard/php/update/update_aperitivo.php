...
include_once 'D:\Xampp\htdocs\F&M_version1.7.1\php\conndb.php';
    ...
    $id_aperitivo = $_GET['id_aperitivo'];
    $stmt = $conn->prepare("SELECT * FROM aperitivos WHERE id_aperitivo = :id_aperitivo");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="titulo-table-dash-container">
                        <h1 class="titulo-table-dash">Modificar Aperitivo</h1>
                    </div>

                    <div class="contenedor-formulario-dash">
                        <form action="..\modificar\modificar_aperitivo.php" autocomplete="off" method="POST" class="formulario-dash">
                            <label for="id_aperitivo">ID Aperitivo:</label>
                            <input type="text" name="id_aperitivo" placeholder="ID" value="<?= $row['id_aperitivo']?>" readonly>

                            <label for="nombre_aperitivo">Nombre: </label>
                            <input type="text" name="nombre_aperitivo" placeholder="Nombre del aperitivo" value="<?= $row['nombre_aperitivo']?>">
                            
                            <input type="submit" name="modificar-aperitivo" class="btn btn-sm btn-success" value="Modificar Aperitivo">
