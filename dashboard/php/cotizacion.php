...
$stmt = $conn->prepare("SELECT * FROM cotizacion");
$stmt->execute();
...
<head>
    ...
    <title>Tabla Prin. Cotización</title>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger text-white">
                                                    ...
                                                    <div class="modal-body">
                                                        Esta acción eliminará el dato de la cotización: <strong><?= $row['id_cotizacion'] ?></strong>. Esta operación no se puede deshacer.
                                                    </div>
